...
namespace KapNet
{
    ...
    public class Server : IReceiveData, IInitable, ITickable, IDisposable
    {
        ...
        {
            BroadcastWithExeption(packet.ipEndPoint, PacketType.Data, packet.payload, packet.metaData);
        }
        ...
        private void HandleHandShake(NetworkPacket networkPacket)
        {
            ...
            BroadcastWithExeption(networkPacket.ipEndPoint, PacketType.ClientJoined, BitConverter.GetBytes(newID), PacketMetaData.Reliable);
        }
        ...
        void BroadcastWithExeption(IPEndPoint exception, PacketType type, byte[] payload = null, PacketMetaData metaData = PacketMetaData.None)
        {
        ...
        void DisconectClient(IPEndPoint ip)
        {
            ...
            BroadcastWithExeption(ip, PacketType.ClientLeft, BitConverter.GetBytes(clients[ip].id), PacketMetaData.Reliable);
